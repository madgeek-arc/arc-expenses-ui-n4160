...
/* stages descriptions */
export const approvalStages = ['1', '2', '3', '5b'];
export const paymentStages = ['7', '7a', '8', '9', '10', '11', '12', '13'];
export const budgetStages = ['1', '2', '4', '5a', '6'];
...
export const budgetStageTitles = {
    '1': 'Υποβολή προϋπολογισμού',
    '2': 'Έγκριση επιστημονικού υπευθύνου',
    '4': 'Βεβαίωση Π.Ο.Υ.',
    '5a': 'Έγκριση Διατάκτη',
    '6': 'Ανάρτηση στην Διαύγεια',
